...
-- EXACT WEBHOOK SYSTEM FROM YOUR SCRIPT
...
local function runServerCheck()
    ...
    local startTime = tick()
    while tick() - startTime < 0.2 and isRunning do
        task.wait(0.1)
    end
...
local function createSettingsGUI()
    ...
    mainFrame.Size = UDim2.new(0, 250, 0, 320) -- Reduced height since webhook settings removed
    ...
    scrollFrame.CanvasSize = UDim2.new(0, 0, 0, 350) -- Reduced for removed webhook settings
